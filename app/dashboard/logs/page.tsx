      ...
      >
        <div>
          ...
          <p style={{ color: "var(--text2)", fontSize: 14 }}>
            Every DM Repliq has sent — with status and type.
          </p>
        </div>
          ...
          >
            ...
            <span
              style={{
                ...
                borderRadius: 10,
                background:
                  filter === t.key ? "rgba(255,255,255,0.2)" : "var(--border)",
              }}
            >
              {counts[t.key]}
            </span>
        ...
        {loading ? (
          ...
          filtered.map((log, i) => (
            ...
            >
              ...
              <span>
                <span
                  className={`badge ${log.type === "actual" ? "badge-green" : "badge-purple"}`}
                >
              ...
              <span>
                <span
                  className={`badge ${log.status === "sent" ? "badge-green" : "badge-red"}`}
                >
                  {log.status}
                </span>
              </span>
              ...
              <a
                href={
                  log.postShortcode
                    ? `https://instagram.com/p/${log.postShortcode}`
                    : (log.postUrl ?? "#")
                }
                target="_blank"
